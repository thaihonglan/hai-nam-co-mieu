...
$base_url="http://hainamlan.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/images/news/'; // path from base_url to upload base dir
$current_path = '/js/tinymce/plugins/filemanager'; // relative path from filemanager folder to upload files folder
