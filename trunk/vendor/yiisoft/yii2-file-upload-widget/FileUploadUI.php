...
class FileUploadUI extends BaseUpload
{
     ...
     */
    public $formView = '@vendor/yiisoft/yii2-file-upload-widget/views/form';
    /**
     * @var string the upload view path to render the js upload template
     */
    public $uploadTemplateView = '@vendor/yiisoft/yii2-file-upload-widget/views/upload';
    /**
     * @var string the download view path to render the js download template
     */
    public $downloadTemplateView = '@vendor/yiisoft/yii2-file-upload-widget/views/download';
    /**
     * @var string the gallery
     */
    public $galleryTemplateView = '@vendor/yiisoft/yii2-file-upload-widget/views/gallery';
